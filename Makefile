...
OFILES = BloodQueen.o myLib.o gameover.o forestcut.o castlecut.o portalcut.o castledoor.o font.o text.o title.o grass.o castle.o throne.o player1.o game.o tree.o heart.o portal.o palacecut.o bosscut.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = myLib.h gameover.h forestcut.h castlecut.h portalcut.h castledoor.h text.h title.h grass.h castle.h throne.h player1.h bosscut.h
